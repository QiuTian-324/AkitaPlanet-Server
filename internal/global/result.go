...
var (
	...
	ErrRegister     = RegisterResult(1001, "注册失败")
	...
	MailHasSend                = RegisterResult(1012, "已朝该邮箱发送验证码（有效期 15 分钟），请检查回收站")
	ErrVerificationCode        = RegisterResult(1013, "验证码错误")
	ErrEmailExist              = RegisterResult(1004, "该邮箱已被注册")
	ErrVerificationCodeExpired = RegisterResult(1014, "验证码已过期")
)
